...
{{if .Warnings}}<section><h2>Repository warnings</h2><ul>{{range .Warnings}}<li>{{.}}</li>{{end}}</ul></section>{{end}}</main><footer><p>Generated fully offline; no external scripts, styles, fonts, or network requests are used.</p><p class="muted brand">Generated by CredScope · Bavlik</p></footer></body></html>`))
